...
(function(){
	...
	Chart.Scale = Chart.Element.extend({
		...
		calculateX1 : function(value, xmin, xmax){
      var innerXwidth = this.width - (this.xScalePaddingLeft + this.xScalePaddingRight);
      var poX_norm = (value - xmin) / (xmax - xmin);
			//return this.endPoint - (scalingFactor * (value - this.min));
			return poX_norm * innerXwidth + this.xScalePaddingLeft;
		},
		...
		draw : function(ease){
			...
			helpers.each(this.datasets,function(dataset){
				...
				helpers.each(dataset.points,function(point,index){
					point.transition({
						y : this.scale.calculateY(point.value),
						//x : this.scale.calculateX1(point.label, this.xdata[0], this.xdata[this.xdata.length-1])
						x : this.scale.calculateX1(this.xdata[index], this.xdata[0], this.xdata[this.xdata.length-1])
					}, easingDecimal);
