setMode -acecf
addConfigDevice -size "generic" -name "ibfbcav2" -path "."
addCollection -name "fpga"
addDesign -version 0 -name "ibfbcav2"
...
addDevice -p 3 -file "../../../Board/GPAC2_1/BPM_FPGA/EXFEL_IBFB_ROUT/sw/hw/download.bit"
