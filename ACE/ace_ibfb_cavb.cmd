setMode -acecf
addConfigDevice -size "generic" -name "ibfbcavb" -path "."
addCollection -name "fpga"
addDesign -version 0 -name "ibfbcavb"
addDeviceChain -index 0
addDevice -p 1 -file "../../../Board/GPAC2_1/SYS_FPGA/EXFEL_LINUX/sw/hw_gpac2_linux/download.bit"
addDevice -p 2 -file "../../../Board/GPAC2_1/BP_FPGA/EXFEL_BUTCAV/sw/hw_bp_butcav/download.bit"
